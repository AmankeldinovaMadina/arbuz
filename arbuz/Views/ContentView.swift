...
struct ContentView: View {
    ...
    func addInitialProducts(context: NSManagedObjectContext) {
        ...
        DataController().addProduct(
            ...
            image: "cola",
            category: "drinks",
            productDescription: "Освежающий газированный напиток с классическим вкусом. Отличный выбор для утоления жажды в жаркий день.",
        ...
        DataController().addProduct(
            ...
            image: "orange_juice",
            category: "drinks",
            productDescription: "Натуральный апельсиновый сок, богатый витаминами и антиоксидантами. Прекрасно подходит для завтрака или в качестве освежающего напитка в течение дня.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "mineral_water",
            category: "drinks",
            productDescription: "Чистая минеральная вода для поддержания вашего здоровья. Помогает восстановить водный баланс и освежает.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "green_tea",
            category: "drinks",
            productDescription: "Зелёный чай в бутылке с нежным ароматом и освежающим вкусом. Полезен для здоровья и способствует улучшению настроения.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "lemonade",
            category: "drinks",
            productDescription: "Лимонный напиток с ярким и освежающим вкусом. Идеален для утоления жажды и поднятия настроения.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "coffee",
            category: "drinks",
            productDescription: "Холодный кофе с насыщенным вкусом и бодрящим эффектом. Отлично подходит для утреннего пробуждения или в качестве перекуса.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "apple_juice",
            category: "drinks",
            productDescription: "Свежевыжатый яблочный сок, богатый витаминами и минералами. Вкусный и полезный напиток для всей семьи.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "milkshake",
            category: "drinks",
            productDescription: "Клубничный молочный коктейль с кремовой текстурой и ярким вкусом. Идеален для сладкого перекуса или десерта.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "energy_drink",
            category: "drinks",
            productDescription: "Энергетический напиток для бодрости и повышения производительности. Поможет справиться с усталостью и сохранить концентрацию.",
            context: managedObjectContext,
            isFav: false
        )
        ...
        DataController().addProduct(
            ...
            productDescription: "Французский багет с хрустящей корочкой и нежной мякотью. Идеален для бутербродов и закусок.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "croissant",
            category: "bread & pastries",
            productDescription: "Масляный круассан с нежной текстурой и богатым вкусом. Прекрасный выбор для завтрака или кофейной паузы.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "muffin",
            category: "bread & pastries",
            productDescription: "Шоколадный маффин с насыщенным вкусом и ароматом. Идеален для сладкого перекуса или десерта.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "donut",
            category: "bread & pastries",
            productDescription: "Сладкий пончик с глазурью, мягкий и воздушный. Прекрасный выбор для утреннего кофе или десерта.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "rye_bread",
            category: "bread & pastries",
            productDescription: "Ржаной хлеб с насыщенным вкусом и ароматом. Полезен для здоровья и отлично сочетается с различными блюдами.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
        ...
        DataController().addProduct(
            ...
            image: "bagel",
            category: "bread & pastries",
            productDescription: "Классический бублик с плотной текстурой и насыщенным вкусом. Прекрасный выбор для завтрака или перекуса.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "pretzel",
            category: "bread & pastries",
            productDescription: "Соленый крендель с хрустящей корочкой и мягкой сердцевиной. Идеален для перекуса или закуски.",
            context: managedObjectContext,
            isFav: false
        )
        DataController().addProduct(
            ...
            image: "cake",
            category: "bread & pastries",
            productDescription: "Шоколадный торт с нежной текстурой и насыщенным вкусом. Прекрасный выбор для праздников и особых случаев.",
            context: managedObjectContext,
            isFav: false
        )
